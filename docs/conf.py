...
# softasap build configuration file, created by
# `ablog start` on Tue Aug 22 20:25:18 2017.
#
...
html_theme = 'sphinx_voronenko_info_theme'
...
htmlhelp_basename = 'voronenkoinfo'
